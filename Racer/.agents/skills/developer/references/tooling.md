...
# Run the application/simulation as a human (play mode)
play:
    uv run -m my_project play

# Test the basic environment with a random agent
test-env:
    uv run -m my_project test-env

# Train a specific agent
train agent="ppo":
    uv run -m my_project train --agent_type={{agent}}
