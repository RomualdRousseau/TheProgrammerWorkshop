...
from tinyrpg.engine import TextBox, Window, WindowLocation, is_action_pressed, play_sound, stop_sound

MESSAGE_WIDTH = int(WORLD_WIDTH * 0.75)  # px
MESSAGE_HEIGHT = int(WORLD_HEIGHT * 0.5)  # px
...
class GameOverBox(Window):
    def __init__(self, text: str):
        super().__init__(MESSAGE_WIDTH, MESSAGE_HEIGHT, WindowLocation.MIDDLE)
