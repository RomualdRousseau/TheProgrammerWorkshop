...
- [ ] **Story 12: Vectorized audio synthesis with numpy**
  ...
  - **Acceptance Criteria:**
    ...
    - [ ] Measurable performance: generating one 1024-frame chunk is at least 10× faster than the previous per-sample Python loop (benchmark figures recorded in the story's implementation notes)
    - [ ] Phase continuity, frequency glide, 1 ms amplitude fade, and stereo panning behave exactly as before (no audible clicks/pops; audible result unchanged)
